                    ...
                    while ($branch = $result_branch->fetch_assoc()) { ?>
                        <div class="widget">
                            ...
                            <div class="schedule-list">
                                <div style="height: 50px;" class="location"><?php echo $branch_name . " ( " . $s_time . ")" ?></div>
                                        ...
                                        <ul>
                                            ...
                                            if ($result_start_time->num_rows > 0) {
                                                while ($st = $result_start_time->fetch_assoc()) { ?>
                                                    <li><a id="<?php echo $count; ?>" <?php $sdBooked = $st['schedule_id']; ?> value="<?php echo $sdBooked; ?>" href="payment/public/index.php?scheduleID=<?php echo $sdBooked ?>"><?php $time = $st['start_time'];
                                                                                                                                                                                                                                    $count += 1;
